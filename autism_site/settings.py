"""
Django settings for autism_site project.
...
SECRET_KEY = 'django-insecure-b5fcz5u9ep*zm*ny-=&lee(kbxl4dnidio6_z(g1(q7t0&3w-x'
...
WSGI_APPLICATION = 'autism_site.wsgi.application'
